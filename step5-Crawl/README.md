...
### *📜 目录：*
&emsp;&emsp;**[1.1. 请求库的安装](#1.1)**<br>
&emsp;&emsp;&emsp;&emsp;[- requests 的安装](#1.1.1)<br>
&emsp;&emsp;&emsp;&emsp;[- Selenium 的安装](#1.1.2)<br>
&emsp;&emsp;**[1.2. [解析库的安装](#1.2)**<br>
&emsp;&emsp;**[1.3. [数据库的安装](#1.3)**<br>
